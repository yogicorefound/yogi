...
namespace cromio::visitor::nodes {
    ...
    struct BinaryExpressionLiteralNode : BaseNode {
        ...
        explicit BinaryExpressionLiteralNode(const std::string& value, const Position start, const Position end) : BaseNode(Kind::BINARY_EXPRESSION, start, end), value(value) {}
    };
